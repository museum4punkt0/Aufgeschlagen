...
namespace com.guidepilot.guidepilotcore {
	[Preserve]
	public class Floor: CoreLinkable, CoreObject, Sorted, Titled {
	[JsonProperty("suuid")]
	...
	[JsonProperty("floor_documents")]
	public FloorDocument[] floorDocuments;
	[JsonProperty("building_id")]
	public int buildingId;
	public void print() {
		Debug.Log("object:" + Environment.NewLine + 	"floorDocuments:" + floorDocuments + Environment.NewLine + 	"buildingId:" + buildingId + Environment.NewLine);
	}
	}
}