...
namespace com.guidepilot.guidepilotcore {
	[Preserve]
	public class CustomTriggerEvent: TriggerEvent {
	//  
	...
	public class VerbConverter : JsonConverter {
		...
		public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer) {
			CustomTriggerEvent.Verb castedValue = (CustomTriggerEvent.Verb)value;
			switch (castedValue) {
			case CustomTriggerEvent.Verb.Triggered:
		...
		public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer) {
			...
			switch (enumString) {
			case "TRIGGERED":
			return CustomTriggerEvent.Verb.Triggered;
			}
			return null;
		}
