...
//  GuidePilot
//
//  Represents a app view on calendar events
//
...
namespace com.guidepilot.guidepilotcore {
	[Preserve]
	public class CalendarView: CoreLinkable, CoreObject, Titled {
	[JsonProperty("suuid")]
	...
	[JsonProperty("calendar_tag_groups")]
	public CalendarTagGroup[] calendarTagGroups;
	[JsonProperty("calendar_filters")]
	public CalendarFilter[] calendarFilters;
	public void print() {
		Debug.Log("object:" + Environment.NewLine + 	"calendarTagGroups:" + calendarTagGroups + Environment.NewLine + 	"calendarFilters:" + calendarFilters + Environment.NewLine);
	}
	}
}