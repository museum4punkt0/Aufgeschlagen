...
namespace com.guidepilot.guidepilotcore {
	[Preserve]
	public class MapLayer: CoreLinkable, CoreObject, Customized, Sorted, Subtitled, Tagged, Titled {
	[JsonProperty("suuid")]
...
[JsonConverter(typeof(DictionaryConverter))]
	...
	public int mapId;
	public void print() {
		Debug.Log("object:" + Environment.NewLine + 	"mapId:" + mapId + Environment.NewLine);
	}
	}
}