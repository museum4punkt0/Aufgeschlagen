...
namespace com.guidepilot.guidepilotcore {
	[Preserve]
	public class ContentProperty: CoreObject, Sorted {
	//  Describes the meaning of the content property.
	...
	public class TypeConverter : JsonConverter {
		...
		public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer) {
			ContentProperty.Type castedValue = (ContentProperty.Type)value;
			switch (castedValue) {
			case ContentProperty.Type.Color:
		...
		public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer) {
			...
			switch (enumString) {
			case "COLOR":
			return ContentProperty.Type.Color;
			}
			return null;
		}
