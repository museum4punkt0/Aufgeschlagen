...
### Lizenz
Aufgeschlagen! Entdecke Bücherschätze im Rokokosaal Copyright © 2022 Klassik Stiftung Weimar / Guidepilot (?) 
Das Programm ist Freie Software: Sie können es unter den Bedingungen der GNU General Public License, wie von der Free Software Foundation, Version 3 der Lizenz oder (nach Ihrer Wahl) jeder neueren veröffentlichten Version, weiterverbreiten und/oder modifizieren. 
